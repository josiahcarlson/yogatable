...
This recipe has been modified from the cookbook version to clean up a few bits
that are from older versions of Python.  You should start from the base recipe
linked below.
...
reserved_names = set('''com1 com2 com3 com4 com5 com6 com7 com8 com9 lpt1 lpt2
    lpt3 lpt4 lpt5 lpt6 lpt7 lpt8 lpt9 con nul prn'''.split())
